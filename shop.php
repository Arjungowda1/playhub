...
<body style="font-family: Poppins;">
    ...
    <div class="container-fluid"
        ...
        <div class="row slider-text align-items-center justify-content-center" style="height: 400px;">
            <div class="col-md-12 text-center">
                <h2 class="animated slideInDown" style="color: white;font-size: 40px;">Catalog</h2>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="get_cat" style="color:black"></div>
            <div id="get_brand" style="color:black"></div>
        
            </div>
   
            <div class="col-md-8" id="get_product" >
...
<!-- modall -->
        <div class="modal fade" id="prod_detail" tabindex="-1"  aria-labelledby="myModalLabel">
				  <div class="modal-dialog" role="document" style="width:850px;">
				    <div class="modal-content">
				      <div class="modal-header">
				        <h4 class="modal-title text-left" id="myModalLabel">Product Details</h4>
				      </div>
				      <div class="modal-body" id='dynamic_content'>
				        
				      </div>
				        <div class="modal-footer">
				        <button type="button" class="py-4" data-dismiss="modal">Close</button>
