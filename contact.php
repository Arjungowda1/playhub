    ...
    <div class="container-fluid"
        ...
        <div class="row slider-text align-items-center justify-content-center" style="height: 400px;">
            <div class="col-md-12 text-center">
                <h2 class="animated slideInDown"style="color: white;font-size: 40px;">Contact us</h2>
                ...
                <div class="container">
                    ...
                    <div class="col-md-4 d-flex text-center">
                        <div class="info bg-white p-4">
                          <p><span>Phone:</span> <a href="#">+91 1235 2355 98</a></p>
                        </div>
                    </div>
                    <div class="col-md-4 d-flex text-center">
                        <div class="info bg-white p-4">
                          <p><span>Email:</span> <a href="#">office@mail.com</a></p>
                        </div>
                    </div>
                    <div class="col-md-4 d-flex text-center">
                        <div class="info bg-white p-4">
                          <p><span>Website:</span> <a href="#">www.Gamestore.com/help</a></p>
                        </div>
                    </div>
                  </div>
                  </div>
        ...
        <div class="row ">
                <div class="col-md-6 justify-content-center d-flex">
                  ...
                  <form action="#" class="bg-white p-5 contact-form">
                    ...
                    <div class="form-group">
                      <input type="submit" value="Send Message" class="btn btn-primary py-3">
                    </div>
                  </form>
                
                </div>
                <div class="col-md-6 justify-content-center">
                    <img src="https://media.giphy.com/media/fkStPRwttwYKY/giphy.gif" width: 430px height: 350px style="position: relative;top:25%;left:25%"/>
                </div>
</div>
</div>
