...
<body style="font-family: Poppins;">
    ...
    <div class="container-fluid"
        ...
        <div class="row slider-text align-items-center justify-content-center" style="height: 400px;">
            <div class="col-md-12 text-center">
                <h2 class="animated slideInDown" style="color: white;font-size: 40px;">Shopping Cart</h2>
                <h6 class="animated slideInDown" style="color: white;"><a href="home.php"
    ...
    <div class="container w3-card mt-5 mb-5">
        <h3 class="usrhed mt-4 ml-2 pt-4">Cart</h3>
      
     <div class="container" id='cartcontents'>   
